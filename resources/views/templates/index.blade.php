<html lang="en" style="height: auto;"><head>
  ...
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center" style="height: 0px;">
      <img class="animation__shake" src="{!! asset('dashboard/dist/img/AdminLTELogo.png') !!}" alt="AdminLTELogo" height="60" width="60" style="display: none;">
    </div>
